...
import { Sun, Moon, Loader2Icon, Menu, X } from "lucide-react"
...
export default function Navbar() {
        ...
        return (
                <header className="sticky border-b border-input top-0 z-50 bg-background center-xl py-5 flex items-center justify-between">
                        ...
                        {/* Mobile nav menu */}
                        {mobileMenuOpen && (
                                <nav className="fixed top-0 left-0 w-full h-full bg-background/95 z-50 flex flex-col items-center justify-center md:hidden transition-all">
                                        <Button
                                                variant="ghost"
                                                size="icon"
